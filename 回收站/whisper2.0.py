...
class GPT3TextSummary:
    ...
    def GPT_generate(self, text, prompt):
        ...
        try:
            ...
            text_return = self.askChatGPT(messages)
            for i in range(4):
                print(".", end="")
                time.sleep(1)
            print()
    ...
    def main(self, file_name, prompt):
        ...
        summary_text = self.GPT_generate(original_text, prompt)
        text_to_be_written = ""
        ...
        self.write_output(text_to_be_written)


if __name__ == '__main__':
    api_key = "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"
    text_summarizer = GPT3TextSummary(api_key)
    file_name = "split.mp3"
